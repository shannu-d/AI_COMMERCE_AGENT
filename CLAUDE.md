...
(approval), M9 (Policy Engine) and M10 (orders and idempotency) are complete. M11–M15 are not
started.**
...
with a database: **1181 tests, all passing, none skipped**; 852 of those need no database.
...
worked example, `tests/ranking/test_ranker.py`) an ordinary unit test, and it is why 852 of the 1181
